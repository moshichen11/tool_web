...
const obfuscatedScript = JavaScriptObfuscator.obfuscate(inlineScript[1], {
  compact: true,
...
const productionHtml = sourceHtml.replace(inlineScript[0], '<script defer src="app.min.js"></script>');
